...
{\bfseries\large August 4, 2025 \par}
\vspace{3ex}
...
assembly of \emph{rhesus macaca}, as it was only available from NCBI,
...
option. Then the pairs are sorted and validated with \emph{pairtools}
using a filter on mapping quality, \(mapq \geq 30\), for both mates.

First, the pipeline was applied to generate high-resolution eigenvector
tracks on the most recent, telomere-to-telomere \emph{rhesus macaca}
assembly, T2T-MMUv8.1 {[}ref{]}, to improve the accuracy of the mapping
