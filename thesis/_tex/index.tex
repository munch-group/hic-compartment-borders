...
\hypersetup{
  ...
  pdfkeywords={Gaussian Random Walk, Bayesian MCMC framework, Chromatin
Structure in spermatogenesis},
  hidelinks,
...
{\bfseries\large July 22, 2025 \par}
\vspace{3ex}
...
genomic positions that interact will yield a positive value in the
...
spatially aware clustering method that soft-assigns compartments.

\chapter{Methods}\label{methods}

I use PyMC {[}ref{]} for all modeling, relying as much as possible on
functions and built-in functionality for all anaysis. I start out small
in the simplest model possible, then progressing to larger and more
complex models.
