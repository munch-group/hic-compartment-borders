...
The model might be able to fit well to the observed data, but it is unlikely that it can generalize. Here it is as a Mermaid-js diagram:

{{< embed ../notebooks/02_PyMC_independent_bins.ipynb#fig-simple_iid_model >}}

Updated with display Image.
