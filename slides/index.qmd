...
::: {.column .tight style="width:70%;transform:scale(0.70);transform-origin: top center;font-size:0.6em;padding-top:20px;"}
...
* We do not know *ground truth*; too sparse data for PCA or the modeling?
...
* Compare **compartment strength** between X- and Y-bearing sperm an all autosomes
